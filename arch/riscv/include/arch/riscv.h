...
#define RISCV_CSR_XSTATUS   __XCONCAT(RISCV_MODE_PREFIX, status)
#define RISCV_CSR_XIE       __XCONCAT(RISCV_MODE_PREFIX, ie)
#define RISCV_CSR_XTVEC     __XCONCAT(RISCV_MODE_PREFIX, tvec)
#define RISCV_CSR_XSCRATCH  __XCONCAT(RISCV_MODE_PREFIX, scratch)
#define RISCV_CSR_XEPC      __XCONCAT(RISCV_MODE_PREFIX, epc)
#define RISCV_CSR_XCAUSE    __XCONCAT(RISCV_MODE_PREFIX, cause)
#define RISCV_CSR_XTVAL     __XCONCAT(RISCV_MODE_PREFIX, tval)
#define RISCV_CSR_XIP       __XCONCAT(RISCV_MODE_PREFIX, ip)
